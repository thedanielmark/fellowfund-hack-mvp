    ...
    <footer id="contact" className="bg-black text-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <p className="text-4xl lg:text-6xl leading-[3rem] text-center text-white font-bold">
          ...
          <Image
            src="/logo-color.png"
            className="-mt-2.5 h-8 w-8 lg:h-20 lg:w-20 ml-3 lg:ml-4 inline"
            height={512}
            width={512}
            alt="FellowFund"
          />
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          &copy; {new Date().getFullYear()} FellowFund. All rights reserved.{" "}
          <br />
          FellowFund is a trademark of DMGHL.
        </p>
      </div>
    </footer>
  );
